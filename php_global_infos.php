...
if(isset($_GET['favicon']))
{
	...
	$black = imagecolorallocate($favicon, 0, 0, 0);
	$purple = imagecolorallocate($favicon, 119, 123, 179);
	$white = imagecolorallocate($favicon, 255, 255, 255);
	imagefilledellipse($favicon, 16, 16, 32, 32, $purple);
	imagecolortransparent($favicon, $black);
	imagestring($favicon, 5, 4, 8, 'php', $white);
	imagepng($favicon);
}
